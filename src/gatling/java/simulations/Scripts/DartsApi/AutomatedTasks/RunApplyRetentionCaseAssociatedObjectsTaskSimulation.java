...
public class RunApplyRetentionCaseAssociatedObjectsTaskSimulation extends Simulation {   
  {
    ...
    final ScenarioBuilder scn1 = scenario("Run Apply Retention Case Associated Objects Task Scenario")
        .exec(GetApiTokenScenario.getApiToken())
        .repeat(1)    
        .on(exec(RunApplyRetentionCaseAssociatedObjectsTaskScenario.RunApplyRetentionCaseAssociatedObjectsTask()
        ));
