...
public class PortalTwoSmokeSimulationTest extends Simulation {   

    private static final String SMOKE_JUDGE_USERS = "Smoke - DARTS - Portal - Judge Users";
    private static final String SMOKE_COURT_CLERK_USERS = "Smoke - DARTS - Portal - Court Clerk Users";
    private static final String SMOKE_COURT_MANAGER_USERS = "Smoke - DARTS - Portal - Court Manager Users ";
    private static final String SMOKE_TRANSCRIBER_USERS = "Smoke - DARTS - Portal - Transcriber Users ";
    private static final String SMOKE_LANGUAGE_USERS = "Smoke - DARTS - Portal - Language Shop Users";
    ...
    public PortalTwoSmokeSimulationTest() {
    ...
    private void setUpScenarios(HttpProtocolBuilder httpProtocolExternal, HttpProtocolBuilder httpProtocolInternal) {
        ...
        ScenarioBuilder smokeJudgeUsers = setUpJudgeUsers(SMOKE_JUDGE_USERS);
        ScenarioBuilder smokeCourtClerkUsers = setUpCourtClerkUsers(SMOKE_COURT_CLERK_USERS);
        ScenarioBuilder smokeCourtManagerUsers = setUpCourtManagerUsers(SMOKE_COURT_MANAGER_USERS);
        ScenarioBuilder smokeTranscriberUsers = setUpTranscriberUsers(SMOKE_TRANSCRIBER_USERS);
        ScenarioBuilder smokeLanguageShopUsers = setUpLanguageShopUsers(SMOKE_LANGUAGE_USERS);
