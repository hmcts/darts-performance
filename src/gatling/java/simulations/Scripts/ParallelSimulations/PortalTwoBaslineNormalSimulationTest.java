...
public class PortalTwoBaslineNormalSimulationTest extends Simulation {   
    ...
    private static final String BASELINE_NORMAL_COURT_MANAGER_USERS = "Baseline Normal - DARTS - Portal - Court Manager Users ";
    private static final String BASELINE_NORMAL_TRANSCRIBER_USERS = "Baseline Normal - DARTS - Portal - Transcriber Users ";
    ...
    public PortalTwoBaslineNormalSimulationTest() {
    ...
    private void setUpScenarios(HttpProtocolBuilder httpProtocolExternal, HttpProtocolBuilder httpProtocolInternal) {
        ...
        ScenarioBuilder smokeCourtManagerUsers = setUpCourtManagerUsers(BASELINE_NORMAL_COURT_MANAGER_USERS);
        ScenarioBuilder smokeTranscriberUsers = setUpTranscriberUsers(BASELINE_NORMAL_TRANSCRIBER_USERS);
