...
public class SOAPRequestBuilder {
    ...
    public static String addDocumentXhibitEventTokenRequest(Session session) {
        ...
        String soapRequest = "<s:Envelope xmlns:s=\"http://schemas.xmlsoap.org/soap/envelope/\">\n" +
                ...
                registrationToken + "</wsse:BinarySecurityToken>\n" +
                "      </wsse:Security>\n" +
                "   </s:Header>\n" +
                "   <s:Body>\n" +
                "      <ns5:addDocument xmlns:ns5=\"http://com.synapps.mojdarts.service.com\">\n" +
                ...
                trimmedID + "&quot; Y=&quot;" + now.format(DateTimeFormatter.ofPattern("yyyy")) +
                "&quot; M=&quot;" + now.format(DateTimeFormatter.ofPattern("MM")) +
                "&quot; D=&quot;" + now.format(DateTimeFormatter.ofPattern("dd")) +
                "&quot; H=&quot;" + now.format(DateTimeFormatter.ofPattern("HH")) +
                "&quot; MIN=&quot;" + now.format(DateTimeFormatter.ofPattern("mm")) +
                "&quot; S=&quot;" + now.format(DateTimeFormatter.ofPattern("ss")) +
                "&quot;&gt;&lt;be:CourtHouse&gt;" + courtHouseName +
                "&lt;/be:CourtHouse&gt;&lt;be:CourtRoom&gt;" + courtRoom +
                "&lt;/be:CourtRoom&gt;&lt;be:CaseNumbers&gt;&lt;be:CaseNumber&gt;Perf_DocXhibitEvent_" +
                caseName + "&lt;/be:CaseNumber&gt;&lt;/be:CaseNumbers&gt;&lt;be:EventText&gt;" +
                eventText + "&lt;/be:EventText&gt;&lt;/be:DartsEvent&gt;</document>\n" +
                "      </ns5:addDocument>\n" +
                "   </s:Body>\n" +
                "</s:Envelope>";
    ...
    public static String addCourtLogUserRequest(Session session, String userName, String password) {
        ...
        // Use StringBuilder for better control over formatting
        String soapRequest = "<soapenv:Envelope xmlns:soapenv=\"http://schemas.xmlsoap.org/soap/envelope/\" xmlns:com=\"http://com.synapps.mojdarts.service.com\">\n" +
                "   <soapenv:Header>\n" +
                "      <ServiceContext token=\"temporary/127.0.0.1-1694086218480-789961425\" xmlns=\"http://context.core.datamodel.fs.documentum.emc.com/\">\n" +
                "         <Identities xsi:type=\"RepositoryIdentity\" userName=\"" + userName + "\" password=\"" + password + "\" repositoryName=\"moj_darts\" domain=\"\" xmlns:xsi=\"http://www.w3.org/2001/XMLSchema-instance\"/>\n" +
                "         <RuntimeProperties/>\n" +
                ...
                "   <soapenv:Body>\n" +
                "      <addLogEntry xmlns=\"http://com.synapps.mojdarts.service.com\">\n" +
                "         <document xmlns=\"\">&lt;log_entry Y=&quot;2023&quot; M=&quot;01&quot; D=&quot;01&quot; H=&quot;10&quot; MIN=&quot;00&quot; S=&quot;00&quot;&gt;&lt;courthouse&gt;" +
                courtHouseName + "&lt;/courthouse&gt;&lt;courtroom&gt;" + courtRoom +
                "&lt;/courtroom&gt;&lt;case_numbers&gt;&lt;case_number&gt;Perf_LogEntry_" + caseName +
                "&lt;/case_number&gt;&lt;/case_numbers&gt;&lt;text&gt;" + randomLogText +
                "&lt;/text&gt;&lt;/log_entry&gt;\n" +
                "         </document>\n" +
                "      </addLogEntry>\n" +
                "   </soapenv:Body>\n" +
