...
// import Utilities.AppConfig.TestType;
...
// public class ProfileAddDocumentSOAPUserSimulation extends Simulation {
...
//     setUp(
//         scn.inject(
//             simulationProfileOpen().toArray(new OpenInjectionStep[0])
//         )
