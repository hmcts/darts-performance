...
public class AppConfig {
    ...
    public enum EnvironmentURL {
        ...
        //External Tennat
        EXTERNAL_CLIENT_ID(getProperty("PERFORMANCE_EXTERNAL_CLIENT_ID", null)),
        EXTERNAL_CLIENT_SECRET(getProperty("PERFORMANCE_EXTERNAL_CLIENT_SECRET", null)),
        EXTERNAL_AZURE_AD_B2C_CLIENT_ID(getProperty("PERFORMANCE_EXTERNAL_AZURE_AD_B2C_CLIENT_ID", null)),

        //Internal Tennat
        INTERNAL_CLIENT_ID(getProperty("PERFORMANCE_INTERNAL_CLIENT_ID", null)),
        INTERNAL_CLIENT_SECRET(getProperty("PERFORMANCE_INTERNAL_CLIENT_SECRET", null)),
        INTERNAL_AZURE_AD_B2C_CLIENT_ID(getProperty("PERFORMANCE_INTERNAL_AZURE_AD_B2C_CLIENT_ID", null)),
