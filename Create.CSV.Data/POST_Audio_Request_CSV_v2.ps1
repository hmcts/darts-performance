...
$query = @"
SELECT DISTINCT ON (subquery.usr_id, subquery.cth_id)
    subquery.hea_id,
    subquery.start_ts,
    subquery.end_ts,
    subquery.usr_id,
	subquery.user_email_address,
...
ORDER BY subquery.usr_id, subquery.cth_id, subquery.user_email_address;
"@
...
$headers = "hea_id,start_ts,end_ts,usr_id,email,courthouse_name,defendant_name,judge_name"
