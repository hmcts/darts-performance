...
WITH UserDetails AS (
    ...
    WHERE  
        ...
        AND urch.cth_id NOT IN (1005, 111, 153, 112, 154, 95, 55, 65, 114, 155, 152, 133, 129, 70, 136, 113, 1002, 1003, 76, 1000)
),
...
RandomDefendant AS (
    ...
    SELECT * FROM (
        ...
        WHERE 
            d.defendant_name IS NOT NULL AND d.defendant_name <> ''
    ) subquery
...
SELECT 
    ...
    -- Case 1
    CASE 
        WHEN rd1.defendant_name IS NULL OR rd1.defendant_name = '' THEN 'Unknown'
        ELSE SUBSTRING(rd1.defendant_name 
            FROM 1 
            FOR CASE WHEN POSITION(' ' IN rd1.defendant_name) > 0 
                     THEN POSITION(' ' IN rd1.defendant_name) - 1 
                     ELSE LENGTH(rd1.defendant_name) END)
    END AS first_name1,
    ...
    -- Case 2
    CASE 
        WHEN rd2.defendant_name IS NULL OR rd2.defendant_name = '' THEN 'Unknown'
        ELSE SUBSTRING(rd2.defendant_name 
            FROM 1 
            FOR CASE WHEN POSITION(' ' IN rd2.defendant_name) > 0 
                     THEN POSITION(' ' IN rd2.defendant_name) - 1 
                     ELSE LENGTH(rd2.defendant_name) END)
    END AS first_name2,
    ...
    -- Case 3
    CASE 
        WHEN rd3.defendant_name IS NULL OR rd3.defendant_name = '' THEN 'Unknown'
        ELSE SUBSTRING(rd3.defendant_name 
            FROM 1 
            FOR CASE WHEN POSITION(' ' IN rd3.defendant_name) > 0 
                     THEN POSITION(' ' IN rd3.defendant_name) - 1 
                     ELSE LENGTH(rd3.defendant_name) END)
    END AS first_name3,
    ...
    -- Case 4
    CASE 
        WHEN rd4.defendant_name IS NULL OR rd4.defendant_name = '' THEN 'Unknown'
        ELSE SUBSTRING(rd4.defendant_name 
            FROM 1 
            FOR CASE WHEN POSITION(' ' IN rd4.defendant_name) > 0 
                     THEN POSITION(' ' IN rd4.defendant_name) - 1 
                     ELSE LENGTH(rd4.defendant_name) END)
    END AS first_name4,
    ...
    -- Case 5
    CASE 
        WHEN rd5.defendant_name IS NULL OR rd5.defendant_name = '' THEN 'Unknown'
        ELSE SUBSTRING(rd5.defendant_name 
            FROM 1 
            FOR CASE WHEN POSITION(' ' IN rd5.defendant_name) > 0 
                     THEN POSITION(' ' IN rd5.defendant_name) - 1 
                     ELSE LENGTH(rd5.defendant_name) END)
    END AS first_name5,
...
# Output file path
$outputFile = "$env:USERPROFILE\Desktop\UsersLanguageShop.csv"
